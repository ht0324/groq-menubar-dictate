...
resolve_release_metadata() {
  ...
  GROQ_DICTATE_ARTIFACT_STEM="${GROQ_DICTATE_ARTIFACT_STEM:-GroqMenuBarDictate-$(sanitize_artifact_component "${GROQ_DICTATE_SHORT_VERSION}-build.${GROQ_DICTATE_BUNDLE_VERSION}-${GROQ_DICTATE_GIT_SHORT_COMMIT}${artifact_dirty_label}")}"
}
